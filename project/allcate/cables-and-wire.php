...
<body>
    ...
    <?php
    $rows = $conn->query("SELECT * from products where status = 1 AND category = 'cables-and-wire'");
    $rows->execute();
    ...
    <section class="sec1">
        <div class="sec_div">
            <p class="path">
                ...
                <a href="sensor.php">cables-and-wire</a>
            </p>
            <div class="sec_div_1">
                <img id="sensor" src="<?php echo APPURL; ?>/admin-panel/products-admins/image/category/cables-and-wire.png" alt="sensor_logo">
                <div>
                    <h1><b> cables-and-wire</b></h1>
                    <p id="head2">Assembly of one or more wires used to transmit electrical power & signals</p>
                    <p id="head4">Electrical cables are used in numerous applications ranging from power transmission and distribution to RF signal transmission in cable TV. Copper is usually used as the main conductor material while plastics are used to isolate individual conductors.</p>
                </div>
            </div>
            <hr id="hr_line">
        </div>

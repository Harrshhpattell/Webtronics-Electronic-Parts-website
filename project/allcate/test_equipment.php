...
<body>
    ...
    <?php
    $rows = $conn->query("SELECT * from products where status = 1 AND category = 'test-equipment'");
    $rows->execute();
    ...
    <section class="sec1">
        <div class="sec_div">
            ...
            <div class="sec_div_1">
                <img id="sensor" src="<?php echo APPURL; ?>/admin-panel/products-admins/image/category/test-equipment.png" alt="sensor_logo">
                <div>
                    <h1><b> Test Equipment</b></h1>
                    <p id="head2"> Electronic devices used to create signals and capture responses from devices under test </p>
                    <p id="head4"> Test equipment is necessary for determining proper set-up, adjustment, operation, maintenance and to detect faults of electronic systems. There are three basic types of electronic test equipment: signal generation devices, measurement devices and the power supply devices. </p>
                </div>
            </div>
            <hr id="hr_line">
        </div>

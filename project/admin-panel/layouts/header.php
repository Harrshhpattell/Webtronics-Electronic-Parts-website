<?php 
session_start();
define("ADMINURL", "http://localhost/DE/project/admin-panel");
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg navbar-light">
      <div class="container">
      <a class="navbar-brand" href="<?php echo ADMINURL; ?>"><img src="<?php echo ADMINURL; ?>/logo/2EBR.png" alt="logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" href=" echo ADMINURL; ?>/categories-admins/show-categories.php" style="margin-left: 20px;">Categories</a>
          </li> -->
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/products-admins/show-products.php" style="margin-left: 20px;">Products</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/orders-products/order-show.php" style="margin-left: 20px;">orders</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/admins/Users.php" style="margin-left: 20px;">Users</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/contact/contact-show.php" style="margin-left: 20px;">contact-us</a>
          </li>
